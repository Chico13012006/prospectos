...
export default function ProcessoComercialPage() {
  ...
  return (
    <div className="p-6 md:p-8 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Processo comercial</h1>
          <p className="text-sm text-slate-400 mt-0.5">Nomenclaturas, parâmetros de renovação/ROI, pipelines e permissões.</p>
        </div>
      </div>
