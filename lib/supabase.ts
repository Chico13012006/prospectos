...
export type Lead = {
  ...
  estagio: 'novos_leads' | 'novo' | 'primeiro_contato' | 'aguardando_resposta' | 'follow_up' | 'follow_up_1' | 'follow_up_2' | 'interessado' | 'respondeu' | 'com_closer' | 'reuniao_agendada' | 'ganho' | 'perdido' | 'sem_resposta' | 'renovacao'
  score: number
