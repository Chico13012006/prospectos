...
export const empresas: Empresa[] = [
  ...
  },
  {
    ...
    observacoes: 'Adriana pediu proposta de projeto piloto. URGENTE — aguarda retorno de Francisca.',
...
export const abordagens: Abordagem[] = [
  ...
  },
  {
    ...
    mensagem_enviada: '[Ligação] Francisca entrou em contato com Adriana Santos para discutir projeto piloto após resposta positiva via LinkedIn.',
    responsavel: 'Francisca', origem_acao: 'humano',
  ...
  },
  {
    ...
    canal: 'WhatsApp',
    mensagem_enviada: 'Oi Luciana! Francisca aqui da InovaCode. Vi sua resposta no WhatsApp e fiquei feliz que tenha interesse! Podemos marcar uma call rápida para entender melhor como podemos ajudar no rastreamento do rebanho?',
    responsavel: 'Francisca', origem_acao: 'humano',
...
export const respostas: Resposta[] = [
  {
    ...
    conteudo: 'Oi Francisca! Achei bem interessante a abordagem de vocês. Temos uma planta nova em Itabira e estamos justamente avaliando sistemas de rastreamento de EPIs e ferramentas. Podemos marcar uma reunião para vocês apresentarem melhor? Tenho disponibilidade na semana que vem.',
...
export const webhookLogs: WebhookLog[] = [
  {
    ...
    payload: { evento: 'lead.criado', lead_id: 'emp-001', empresa: 'LogTech Brasil', segmento: 'Logística', responsavel: 'Francisca', cadencia_id: 'cad-001', timestamp: '2026-06-01T09:00:00Z' },
  ...
  },
  {
    ...
    payload: { evento: 'resposta.positiva', lead_id: 'emp-003', acao: 'criar_followup_urgente', notificar: 'Francisca', prioridade: 'alta', timestamp: '2026-05-22T16:45:10Z' },
  ...
  },
  {
    ...
    payload: { evento: 'followup.atrasado', lead_id: 'emp-003', followup_id: 'fup-001', dias_atraso: 23, responsavel: 'Francisca', acao: 'alertar_responsavel', timestamp: '2026-06-15T08:00:00Z' },
  ...
  },
  {
    ...
    payload: { evento: 'lead.criado', lead_id: 'emp-004', empresa: 'AgroFast Soluções', segmento: 'Agro', responsavel: 'Francisca', cadencia_id: 'cad-003', timestamp: '2026-06-14T08:00:00Z' },
